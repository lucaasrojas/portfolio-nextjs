...
const Experience = () => {
  return (
    <section id="experience" className="experience px-10 py-16">
          ...
          <div className="company-box" key={`company-${company.company}`}>
            ...
            {company.projects.map((project) => (
              <div
                ...
                className="experience-content_project"
              >
                <h4 className="experience-content_project-title font-semibold">
                  {project.title}
                </h4>
                <ul className="experience-content_project-list">
                  {project.extra.map((extra, i) => (
                    <li
                      key={`${company.company}-${project.title}-content-${i}`}
                    >
                      {extra}
                    </li>
                  ))}
